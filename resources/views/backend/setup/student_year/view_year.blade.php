                      ...
                      <tbody>
                          @foreach ($alldata as $key => $studentyear)   
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('student.year.edit',$studentyear->id) }}" class="btn btn-info">Edit</a>
                                        <a href="{{ route('student.year.delete',$studentyear->id) }}" class="btn btn-danger" id="delete">Delete</a>
                                    </td>
